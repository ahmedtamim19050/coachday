    ...
    <section class="container mb-5 pb-md-5 mt-4 mt-md-5">
        ...
        <form class="bg-light shadow-sm rounded-3 p-3 p-md-4 multi-step-form" data-multi-step method="post"
            ...
            <div class="step-form" data-step>
                <h3 class="h6 text-gray-900">Auswahl</h3>
                <div class="card p-3 p-md-4 mb-3">
                    <div class="form-check package">
                        <input class="form-check-input" id="form-radio-1" type="radio" name="checkout-coach" checked>
                        <label class="form-check-label w-100" for="form-radio-1">
                            <div class="d-flex justify-content-between align-items-start">
                                <div class="d-block">
                                    <h6 class="mb-1">PREMIUM-Version</h6>
                                    <p class="mb-0">Werden monatlich in Rechnung gestellt</p>
                                </div>
                                <span class="text-gray-900 fw-bold package-price">200.00€</h5>
                            </div>
                        </label>
                    </div>
                </div>
                <div class="card p-3 p-md-4 mb-3">
                    <div class="form-check package">
                        <input class="form-check-input" id="form-radio-2" type="radio" name="checkout-coach">
                        <label class="form-check-label w-100" for="form-radio-2">
                            <div class="d-flex justify-content-between align-items-start">
                                <div class="d-block">
                                    <h6 class="mb-1">Basic-Version</h6>
                                    <p class="mb-0">Werden monatlich in Rechnung gestellt</p>
                                </div>
                                <span class="text-gray-900 fw-bold package-price">100.00€</span>
                            </div>
                        </label>
                    </div>
                </div>

                <h3 class="h6 text-gray-900 mt-5">Zusammenfassung</h3>
                <div class="card px-3 pt-3 pb-2 px-md-4 mb-3">
                    <div
                        ...
                        <div class="d-block">
                            <p class="mb-1 text-gray-900">Bruttopreis: <span class="package-name">PREMIUM-Version</span>
                            </p>
                        </div>
                        <div class=" h5 mb-0" id="nettopreis"></div>
                    ...
                    <div
                        ...
                        <div class=" h5 mb-0" id="umsatzsteuer"></div>
                    ...
                    <div class="d-flex justify-content-sm-between flex-column flex-sm-row align-items-sm-center py-2">
                        <div class="d-block">
                            <p class="mb-1 ">Gesamtbetrag</p>
                        </div>
                        <div class="text-primary h5 mb-0" id="gesamtbetrag"></div>
                ...
                <div class="d-flex justify-content-md-end justify-content-center my-4">
                    <button type="button" class="btn btn-primary rounded-pill" data-next>Zur Bezahlung<i
                            class="fi-chevron-right fs-sm ms-2"></i></button>
                </div>


                <ul class="list list-payment-block align-items-center justify-content-center justify-content-md-end mt-3 mb-3"
                    role="list">
                    <li class="list-payment-block__item">
                    ...
                    <li class="list-payment-block__item">
                        <svg class="icon icon--full-color" width="38" height="24" viewBox="0 0 38 24"
                    ...
                    <li class="list-payment-block__item">
                        <svg class="icon icon--full-color" viewBox="-36 25 38 24" xmlns="http://www.w3.org/2000/svg"
            ...
            <div class="step-form" data-step>
                <h3 class="h6 text-gray-900">Kasse</h3>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            function updatePrices() {
                const selectedPackage = document.querySelector('.form-check-input:checked');
                if (!selectedPackage) {
                ...
                const selectedLabel = document.querySelector(`label[for="${selectedLabelId}"]`);
                ...
                const packageName = selectedLabel.querySelector('span').textContent;
                const packagePriceText = selectedLabel.querySelector('.package-price').textContent;
                const packagePrice = parseFloat(packagePriceText.replace('€', '').replace(',', '.'));

                if (isNaN(packagePrice)) {
                    console.error('Invalid package price:', packagePriceText);
                    return;
                }

                const nettopreis = packagePrice / 1.19;
                const umsatzsteuer = packagePrice - nettopreis;
                ...
                gesamtbetragElement.textContent = packagePrice.toFixed(2) + '€';

                // Set hidden input values
                nettopreisInput.value = nettopreis.toFixed(2);
                umsatzsteuerInput.value = umsatzsteuer.toFixed(2);
                gesamtbetragInput.value = packagePrice.toFixed(2);
            }
